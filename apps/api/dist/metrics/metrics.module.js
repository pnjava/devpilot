...
exports.MetricsModule = MetricsModule = __decorate([
    (0, common_1.Module)({
        providers: [engine_service_1.MetricsEngineService, insights_service_1.InsightsService],
        exports: [engine_service_1.MetricsEngineService, insights_service_1.InsightsService],
    })
], MetricsModule);
